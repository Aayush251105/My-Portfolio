...
function Hero() {
  return (
    <div className="pb-20 pt-36">
      ...
      <div className="flex h-screen w-full items-center justify-center bg-white dark:bg-black-100 dark:bg-grid-white/[0.05] bg-grid-black/[0.2] absolute top-0 left-0">
        <div
          className={cn(
            "absolute inset-0",
