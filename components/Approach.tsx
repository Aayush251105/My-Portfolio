  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card title="Understand & Define" icon={<AceternityIcon order= "Phase 1"/>}
            description="I begin by understanding the problem, clarifying requirements, and mapping out user needs. This sets a clear direction and ensures the project solves the right challenges."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card title="Design & Build" icon={<AceternityIcon order="Phase 2" />}
            description="I translate ideas into clean UI/UX and build scalable, high-quality systems using modern tools. I focus on performance, maintainability, and a smooth user experience."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="Test, Refine & Deliver" icon={<AceternityIcon order="Phase 3" />}
            description="I rigorously test, optimize, and refine the product for reliability. Feedback loops, debugging, and polish ensure a stable, production-ready final result."
        >
          <CanvasRevealEffect
            animationSpeed={3}
...
const AceternityIcon = ( {order}: {order:string} ) => {
  return (
    <div>
        <button className="relative inline-flex h-12 overflow-hidden border rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
